...
맥에서 **`사관 스튜디오 실행.command`를 더블클릭**하면 **강의 자료 작업실**에서 시작합니다. 이곳이 앱의 메인입니다. 자동 그림 제작 없이 쓰려면 `index.html`을 직접 열어도 됩니다. 기존 보조 도구에서 작업 중이었다면 마지막 화면을 이어 엽니다. 기본 제작 흐름에는 API 키가 필요 없습니다.

![강의 자료 작업실 시작 화면](docs/teaching-home.png)
