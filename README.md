...
`index.html`을 브라우저에서 열고 **✦ 자료 제작**을 누르세요. 새 브라우저에서는 이 화면부터 시작합니다. 기본 제작 흐름에는 API 키가 필요 없습니다.
...
6. **그림 주문서 받기** — 주문서 ZIP을 Codex·ChatGPT에 전달해 삽화를 생성하고, 지정 파일 이름 그대로 **만든 그림 불러오기**로 넣습니다. 웹 앱이 구독 계정에 직접 접속해 그림을 만들지는 않습니다.
